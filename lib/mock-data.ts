import type { Company, Category, Product, Order, User, Promotion } from './types'
...
export const mockCompanies: Company[] = [
  {
    ...
    description: 'Os melhores salgados da cidade! Tradição e sabor em cada mordida.',
    ...
    businessHours: [
      ...
      { dayOfWeek: 5, dayName: 'Sexta', isOpen: true, openTime: '08:00', closeTime: '20:00' },
      { dayOfWeek: 6, dayName: 'Sábado', isOpen: true, openTime: '09:00', closeTime: '15:00' },
    ],
...
export const mockProducts: Product[] = [
  // Mini Pastel Category
  {
    ...
    description: 'Mini pastel de 12 a 15 gramas. Perfeito para festas e eventos!',
...
export const mockOrders: Order[] = [
  {
    ...
    items: [
      { productId: '1', productName: '100 Mini Pastel', quantity: 1, unitPrice: 95.00, subtotal: 95.00 },
      { productId: '12', productName: 'Refrigerante Lata', quantity: 2, unitPrice: 6.00, subtotal: 12.00 },
    ],
    total: 107.00,
    status: 'pending',
    paymentMethod: 'pix',
  ...
  },
  {
    ...
    items: [
      { productId: '5', productName: 'Combo 40 Salgados', quantity: 1, unitPrice: 65.00, subtotal: 65.00 },
    ],
    total: 65.00,
    status: 'confirmed',
  ...
  },
  {
    ...
    items: [
      { productId: '8', productName: 'Coxinha', quantity: 10, unitPrice: 5.00, subtotal: 50.00 },
      { productId: '9', productName: 'Esfiha', quantity: 5, unitPrice: 4.50, subtotal: 22.50 },
    ],
    total: 72.50,
    status: 'delivered',
    paymentMethod: 'cash',
...
export function getCategoriesByCompany(companyId: string): Category[] {
  return mockCategories.filter(c => c.companyId === companyId).sort((a, b) => a.order - b.order)
}
...
export const defaultBusinessHours = [
  { dayOfWeek: 0, dayName: 'Domingo', isOpen: false, openTime: '18:00', closeTime: '23:00' },
  { dayOfWeek: 1, dayName: 'Segunda', isOpen: true, openTime: '18:00', closeTime: '23:00' },
  { dayOfWeek: 2, dayName: 'Terça', isOpen: true, openTime: '18:00', closeTime: '23:00' },
  { dayOfWeek: 3, dayName: 'Quarta', isOpen: true, openTime: '18:00', closeTime: '23:00' },
  { dayOfWeek: 4, dayName: 'Quinta', isOpen: true, openTime: '18:00', closeTime: '23:00' },
  { dayOfWeek: 5, dayName: 'Sexta', isOpen: true, openTime: '18:00', closeTime: '23:00' },
  { dayOfWeek: 6, dayName: 'Sábado', isOpen: true, openTime: '18:00', closeTime: '23:00' },
]
