...
import { getOrdersByCompany, formatCurrency, orderStatusLabels, orderStatusColors } from '@/lib/mock-data'
import { DollarSign, TrendingUp, ShoppingBag, Package, Calendar } from 'lucide-react'
        ...
        <div className="bg-card border rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-foreground">{formatCurrency(stats.averageOrder)}</p>
            </div>
          </div>
        </div>
      </div>
